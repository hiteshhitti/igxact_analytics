...
SHEET_URL = "https://docs.google.com/spreadsheets/d/1GZEIpJPYmhN6tc9EICIdqizo3AUH_panG_BUjE8hTWk/export?format=csv&gid=1165644332"
...
def get_data():
    try:
        ...
        veh_full = df.groupby("Vehicle Details")[[
            "Deal Price", "Fuel", "Tolls & Taxes",
            "Parking", "Driver Allowance",
            "Sales Commission", "Number of Days"
        ]].sum()
